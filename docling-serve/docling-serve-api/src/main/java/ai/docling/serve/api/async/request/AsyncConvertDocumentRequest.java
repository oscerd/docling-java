...
/**
 * Represents a request for asynchronous document conversion.
 *
 * <p>This class extends the standard conversion request with additional configuration
...
@tools.jackson.databind.annotation.JsonDeserialize(builder = AsyncConvertDocumentRequest.Builder.class)
@lombok.extern.jackson.Jacksonized
@lombok.Builder(toBuilder = true)
@lombok.Getter
@lombok.ToString
public class AsyncConvertDocumentRequest {
